...
$encrypted_string_encoded = encrypt_string_and_encode($my_salt, $string);
echo "Encrypted: ". $encrypted_string . "<br />";
echo "Encrypted (Encoded): ". $encrypted_string_encoded . "<br />";
echo "<br />";

$decrypted_string = decrypt_string($my_salt, $encrypted_string);
$decrypted_string_decoded = decrypt_string_and_decode($my_salt, $encrypted_string_encoded);
echo "Decrypted: ". $decrypted_string . "<br />";
echo "Decrypted (Decoded): ". $decrypted_string_decoded . "<br />";
echo "<br />";
