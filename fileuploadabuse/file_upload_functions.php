...
$upload_path = "/media/angga/Data/Sandbox/php/security/fileuploadabuse/upload";
...
function upload_file($field_name)
{
    ...
    if (isset($_FILES[$field_name])) {
        ...
        // USE ABSOLUTE PATH so hacker cannot inject file by pointing file via relative filename
        ...
        if ($error > 0) {
            ...
            if (move_uploaded_file($tmp_file, $file_path)) {
                ...
                echo "Upload destination may unavailable or permission denied";
            }
        }
    }
}
